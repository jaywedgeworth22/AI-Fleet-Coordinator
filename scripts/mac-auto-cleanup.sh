...
KEEP_RE = re.compile(
    ...
    r"^/Users/jay/apps/(agent-sync|agent-sync-push|grok-acp-runtime|agy-acp-runtime|shellular-runtime|mac-collab|senate-relay-runtime|scout-runtime|dsh-runtime|harness-runtime|seat-mcp|KIMI-SALVAGE-.*)$|"
    r"^/Users/jay/Code/.*$"
)
